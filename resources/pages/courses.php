<section id="Courses" class="p-0 p-md-3">
    <!-- TODO: zdjecia placeholdery, najlepiej jakby byly zdjecia z kursow -->
    <div class="container-fluid">
        <div class="row align-items-center p-md-3 p-0">
            <div class="col-12 col-md-4 order-md-2">
                <img class="img-fluid d-block p-5 p-md-0 m-auto" src="/img/placeholder.png"/>
            </div>
            <div class="col col-md-8 d-flex flex-column align-items-center">
                <a class="anchor" id="kurs-azbuka"></a>
                <h1>Kurs <i>Azbuka</i></h1>
                <h5>Dla dzieci (w wieku 7-14 lat)</h5>
                <p class="mt-3">
        ...
        <div class="row align-items-center p-md-3 p-0">
            ...
            <div class="col col-md-8 d-flex flex-column align-items-center">
                <a class="anchor" id="kurs-egzaminacyjny"></a>
                <h1>Kursy egzaminacyjne</i></h1>
                <h5>Maturalny, ósmoklasisty, TELC, TRKI</h5>
                <p class="mt-3">
        ...
        <div class="row align-items-center p-md-3 p-0">
            ...
            <div class="col col-md-8 d-flex flex-column align-items-center">
                <a class="anchor" id="kurs-wakacyjny"></a>
                <h1>Kursy wakacyjne</i></h1>
                <h5>Czterotygodniowe, na wszystkich poziomach</h5>
                <p class="mt-3">
        ...
        <div class="row align-items-center p-md-3 p-0">
            ...
            <div class="col col-md-8 d-flex flex-column align-items-center">
                <a class="anchor" id="kurs-specjalistyczny"></a>
                <h1>Kursy specjalistyczne</h1>
                <p class="mt-3">
        ...
        <div class="row align-items-center p-md-3 p-0">
            ...
            <div class="col col-md-8 d-flex flex-column align-items-center">
                <a class="anchor" id="kurs-indywidualny"></a>
        ...
        <div class="row align-items-center p-md-3 p-0">
            ...
            <div class="col col-md-8 d-flex flex-column align-items-center">
                <a class="anchor" id="kurs-polski-dla-obcokrajowcow"></a>
                <h1>Kursy dla obcokrajowców</h1>
                <p class="mt-3">
