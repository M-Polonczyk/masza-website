    ...
    <div class="navbar-collapse collapse" id="navbarSupportedContent">
        <ul class="navbar-nav flex-wrap justify-content-center align-items-center flex-grow-1">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarKursyDropdown" href="#" role="button" data-toggle="dropdown">Kursy</a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="/kursy.php#kurs-azbuka">Dla dzieci</a>
                    <a class="dropdown-item" href="/kursy.php#kurs-ogolny">Ogólne</a>
                    <a class="dropdown-item" href="/kursy.php#kurs-specjalistyczny">Specjalistyczne</a>
                    <a class="dropdown-item" href="/kursy.php#kurs-egzaminacyjny">Egzaminacyjne</a>
                    <a class="dropdown-item" href="/kursy.php#kurs-indywidualny">Indywidualne</a>
                    <a class="dropdown-item" href="/kursy.php#kurs-polski-dla-obcokrajowcow">Polski dla obcokrajowców</a>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/tlumaczenia.php">Tłumaczenia</a>
            </li>
            <li class="nav-item">
